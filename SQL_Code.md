...
```
# 4. Identify products where the average purchase quantity per order is two but with a high total revenue.
...
```
# 6. Analyze the month-on-month percentage change in total sales.
